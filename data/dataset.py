...
class COCODataset(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, img_size=(640, 640), name="train2017", json_file="voc2012_trainval.json", preproc=None,
